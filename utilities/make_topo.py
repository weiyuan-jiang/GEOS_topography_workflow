...
_EOF_
   ...
   cat ${{config_file}}
   mpirun -np 6 bin/generate_scrip_cube.x
   ...
   set arr = `ls *.nc`
   echo $arr
   ../bin/scrip_to_restart.py -i $arr -o gwd_internal_rst
   ../bin/convert_to_gmao_output.x -i $arr --im $im
   cd ..
   @ count = $count + 1
end
"""
...
def ask_questions():
   ...
   questions = [
...

       {
            ...
            "default": "/discover/nobackup/bmauer/gmted_topo/gmted_fix_superior/"
        },
